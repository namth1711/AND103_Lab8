...
public class Adapter_Province_Select_GHN extends ArrayAdapter<Province> {
    private Context context;
    private ArrayList<Province> list;

    public Adapter_Province_Select_GHN(@NonNull Context context, ArrayList<Province> list) {
