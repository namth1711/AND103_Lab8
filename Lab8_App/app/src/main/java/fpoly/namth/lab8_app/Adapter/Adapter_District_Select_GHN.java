...
public class Adapter_District_Select_GHN extends ArrayAdapter<District> {
    private Context context;
    private ArrayList<District> list;

    public Adapter_District_Select_GHN(@NonNull Context context, ArrayList<District> list) {
