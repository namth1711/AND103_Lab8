...
import fpoly.namth.lab8_app.Adapter.Adapter_District_Select_GHN;
import fpoly.namth.lab8_app.Adapter.Adapter_Province_Select_GHN;
import fpoly.namth.lab8_app.Adapter.Adapter_Ward_Select_GHN;
...
import fpoly.namth.lab8_app.R;
import fpoly.namth.lab8_app.Serives.GHNRequest;
import fpoly.namth.lab8_app.Serives.GHNServices;
import fpoly.namth.lab8_app.databinding.ActivityLocationBinding;
...
public class LocationActivity extends AppCompatActivity {
    ...
    private Adapter_Province_Select_GHN adapter_province_select_ghn;
    private Adapter_District_Select_GHN adapter_district_select_ghn;
    private Adapter_Ward_Select_GHN adapter_ward_select_ghn;
    @Override
    ...
    private void SetDataSpinProvince(ArrayList<Province> ds){
        adapter_province_select_ghn = new Adapter_Province_Select_GHN(this, ds);
        binding.spProvince.setAdapter(adapter_province_select_ghn);
    }

    private void SetDataSpinDistrict(ArrayList<District> ds){
        adapter_district_select_ghn = new Adapter_District_Select_GHN(this, ds);
        binding.spDistrict.setAdapter(adapter_district_select_ghn);
    }

    private void SetDataSpinWard(ArrayList<Ward> ds){
        adapter_ward_select_ghn = new Adapter_Ward_Select_GHN(this, ds);
        binding.spWard.setAdapter(adapter_ward_select_ghn );
    }
